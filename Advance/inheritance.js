...
// In prototypal inheritance, objects can serve as prototypes for other objects, 
// forming a hierarchical chain of inheritance.
...
// 1st - parent object creation (constructor function)
 ...
 Animal.prototype.sound =function (name){
    return `Animal Sound ${this.name}`;
 }
